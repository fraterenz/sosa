...
Once this trait is implemented, a simulation loop can be called with [`simulate`](https://docs.rs/sosa/3.0.5/sosa/fn.simulate.html), see the [example](https://docs.rs/sosa/3.0.5/sosa/fn.simulate.html#example).
